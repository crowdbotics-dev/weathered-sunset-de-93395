...
## Project Structure
    ...
    ├── weathered_sunset_de_93395  # Django project configurations
...
1. Clone this repo and `cd weathered_sunset_de_93395`
...
2. Clone this repo and `cd weathered_sunset_de_93395`
